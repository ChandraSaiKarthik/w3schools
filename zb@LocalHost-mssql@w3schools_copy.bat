...
set "mssqltarget=C:\zProjects\w3schools_copy-local\src\main\resources\database\mssql"
...
set "targetfile=%mssqltarget:C:\=/c/%/fill_in_placeholders.sh"
...
python pymssql_deploy.py --DB_HostName="localhost" --DB_UserName="karthik" --DB_Password="asdf1234" --DB_Name="w3schools_copy"
echo.
