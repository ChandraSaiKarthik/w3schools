...
IF NOT EXISTS (SELECT 1 FROM sys.fn_listextendedproperty('Description', 'SCHEMA', 'dbo', 'TABLE', 'OrderDetails', 'COLUMN', 'OrderID') )
	EXEC sys.sp_addextendedproperty 'Description', 'The unique identifier for the order that the order detail belongs to and references OrderID in Orders Table.', 'SCHEMA', 'dbo', 'TABLE', 'OrderDetails', 'COLUMN', 'OrderID';
IF NOT EXISTS (SELECT 1 FROM sys.fn_listextendedproperty('Description', 'SCHEMA', 'dbo', 'TABLE', 'OrderDetails', 'COLUMN', 'ProductID') )
	EXEC sys.sp_addextendedproperty 'Description', 'The unique identifier for the product that the order detail represents and references ProductID in Products Table.', 'SCHEMA', 'dbo', 'TABLE', 'OrderDetails', 'COLUMN', 'ProductID';
...
IF NOT EXISTS (SELECT 1 FROM sys.fn_listextendedproperty('MS_Description', 'SCHEMA', 'dbo', 'TABLE', 'Orders', 'COLUMN', 'CustomerID') )
	EXEC sys.sp_addextendedproperty 'MS_Description', 'The unique identifier for the customer associated with the order that references the CustomerID column in the Customers table.', 'SCHEMA', 'dbo', 'TABLE', 'Orders', 'COLUMN', 'CustomerID';
IF NOT EXISTS (SELECT 1 FROM sys.fn_listextendedproperty('MS_Description', 'SCHEMA', 'dbo', 'TABLE', 'Orders', 'COLUMN', 'EmployeeID') )
	EXEC sys.sp_addextendedproperty 'MS_Description', 'The unique identifier for the employee associated with the order that references the EmployeeID column in the Employees table.', 'SCHEMA', 'dbo', 'TABLE', 'Orders', 'COLUMN', 'EmployeeID';
...
IF NOT EXISTS (SELECT 1 FROM sys.fn_listextendedproperty('MS_Description', 'SCHEMA', 'dbo', 'TABLE', 'Orders', 'COLUMN', 'ShipperID') )
	EXEC sys.sp_addextendedproperty 'MS_Description', 'The unique identifier for the shipper associated with the order that references the ShipperID column in the Shippers table.', 'SCHEMA', 'dbo', 'TABLE', 'Orders', 'COLUMN', 'ShipperID';
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.fn_listextendedproperty('MS_Description', 'SCHEMA', 'dbo', 'TABLE', 'Products', 'COLUMN', 'SupplierID') )
	EXEC sys.sp_addextendedproperty 'MS_Description', 'The unique identifier for the supplier associated with the product that references the SupplierID column in the Suppliers table.', 'SCHEMA', 'dbo', 'TABLE', 'Products', 'COLUMN', 'SupplierID';
IF NOT EXISTS (SELECT 1 FROM sys.fn_listextendedproperty('MS_Description', 'SCHEMA', 'dbo', 'TABLE', 'Products', 'COLUMN', 'CategoryID') )
	EXEC sys.sp_addextendedproperty 'MS_Description', 'The unique identifier for the category associated with the product that references the CategoryID column in the Categories table.', 'SCHEMA', 'dbo', 'TABLE', 'Products', 'COLUMN', 'CategoryID';
