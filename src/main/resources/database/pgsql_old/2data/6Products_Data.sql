...
USING (
	  ...
	  ) AS S ("ProductID", "ProductName", "SuplID", "CatID", "Unit", "Price")
	ON T."ProductID" = S."ProductID"
WHEN MATCHED AND (T."ProductName" IS DISTINCT FROM S."ProductName") OR (T."SuplID" IS DISTINCT FROM S."SuplID") OR (T."CatID" IS DISTINCT FROM S."CatID") OR (T."Unit" IS DISTINCT FROM S."Unit") OR (T."Price" IS DISTINCT FROM S."Price")
	THEN UPDATE SET "ProductName" = S."ProductName", "SuplID" = S."SuplID", "CatID" = S."CatID", "Unit" = S."Unit", "Price" = S."Price"
WHEN NOT MATCHED
	THEN INSERT ("ProductID", "ProductName", "SuplID", "CatID", "Unit", "Price")
		 OVERRIDING SYSTEM VALUE
		 VALUES (S."ProductID", S."ProductName", S."SuplID", S."CatID", S."Unit", S."Price")
;
