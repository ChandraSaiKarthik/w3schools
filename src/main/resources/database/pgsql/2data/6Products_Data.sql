MERGE INTO public.products AS T
USING (
        VALUES
      ...
      ) AS S (product_id, product_name, sup_id, cat_id, unit, price)
    ON T.product_id = S.product_id
WHEN MATCHED AND (T.product_name IS DISTINCT FROM S.product_name) OR (T.sup_id IS DISTINCT FROM S.sup_id) OR (T.cat_id IS DISTINCT FROM S.cat_id) OR (T.unit IS DISTINCT FROM S.unit) OR (T.price IS DISTINCT FROM S.price)
    THEN UPDATE SET product_name = S.product_name, sup_id = S.sup_id, cat_id = S.cat_id, unit = S.unit, price = S.price
WHEN NOT MATCHED
    THEN INSERT (product_id, product_name, sup_id, cat_id, unit, price)
         OVERRIDING SYSTEM VALUE
         VALUES (S.product_id, S.product_name, S.sup_id, S.cat_id, S.unit, S.price)
;
