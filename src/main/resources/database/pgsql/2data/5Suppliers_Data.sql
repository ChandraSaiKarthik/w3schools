...
WHEN MATCHED AND (T.SupplierName IS DISTINCT FROM S.SupplierName OR 
                  T.ContactName IS DISTINCT FROM S.ContactName OR
                  T.Address IS DISTINCT FROM S.Address OR
